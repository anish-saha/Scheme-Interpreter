...
(begin (define x 12) (/ 6 2))
; expect 3

(lambda (n m) (* n m))
; expect (lambda (n m) (* n m))
...
(lambda (a b c) (* a b))
; expect (lambda (a b c) (* a b))

(lambda (x y) (+ x y))
; expect (lambda (x y) (+ x y))

(define quadruple (lambda (x) (* x 4)))
; expect quadruple
(quadruple 9)
; expect 36

(define (sum-quad x y) (+ (quadruple x) (quadruple y)))
; expect sum-quad
(sum-quad 2 3)
; expect 20
...
(define testy (begin (* 2 8) '(print 8)))
; expect testy

testy
; expect (print 8)

(define tester (begin (display 8) (display 3)))
; expect 83tester

((lambda (x y) (* x (+ x y))) 8 3)
; expect 88

(define lambdat (lambda (a b c) (+ a b (* b c))))
; expect lambdat

(lambdaT 3 6 8)
; expect 57

(define (deftest x)(+ x 28))
; expect deftest
...
(or True (print 3) True)
; expect True

(and False (display 88))
; expect False
